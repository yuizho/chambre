...
interface ReactiveUnapprovedUserRepository {
    fun findUnapprovedUserBy(roomId: Room.Id, userId: User.Id): Mono<UnapprovedUser>
    fun findUnapprovedUsers(roomId: Room.Id): Flux<UnapprovedUser>
    fun contains(roomId: Room.Id, userId: User.Id): Mono<Boolean>
    fun put(roomId: Room.Id, unapprovedUser: UnapprovedUser): Mono<Boolean>
    fun remove(roomId: Room.Id, userId: User.Id): Mono<Boolean>
}